...
@section('content')
<style>
    /* Action Button Container (for the specific action buttons) */
    .action-buttons {
        display: flex;
    ...
    /* Ensure only buttons inside .action-buttons are affected */
    .action-buttons .btn {
        font-size: 0.85rem;
    ...
    /* On small screens (mobile devices), stack buttons vertically and make them full width */
